...
RCT_EXPORT_METHOD(showPaymentViewController:(RCTResponseSenderBlock)callback)
{
  dispatch_async(dispatch_get_main_queue(), ^{
      ...
      dropInViewController.view.tintColor = [UIColor colorWithRed:0.16 green:0.75 blue:0.51 alpha:1.0];

      dropInViewController.navigationItem.leftBarButtonItem.tintColor = [UIColor colorWithRed:0.16 green:0.75 blue:0.51 alpha:1.0];
      dropInViewController.summaryTitle = @"Cashew";
      dropInViewController.summaryDescription = @"You'll need to add a card to your account first.";
