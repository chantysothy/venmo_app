...
var Spinner = (0, _autobindDecorator2.default)(_class = (_temp = _class2 = function (_React$Component) {
  ...
  _createClass(Spinner, [{
    ...
    value: function componentWillMount() {
      if (_reactNative.Platform.OS === 'android') tag = Portal.allocateTag();
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      if (_reactNative.Platform.OS === 'android') tag = null;
    }
  }, {
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (!prevProps.visible && this.props.visible) return Portal.showModal(tag, this._renderSpinner());
    ...
    value: function _renderSpinner() {
      ...
      if (!this.props.visible) return _reactNative2.default.createElement(_reactNative.View, null);
      ...
      var spinner = _reactNative2.default.createElement(
        _reactNative.View,
      ...
      if (_reactNative.Platform.OS === 'android') return spinner;
  ...
  return Spinner;
}(_reactNative2.default.Component), _class2.propTypes = {
